...
/**
 * <code>GnuRegExpFactory</code> extends {@link RegExpFactory} for
 * regular expressions of the gnu.regexp package. 
 * 
 * @author Joerg Steffen, DFKI
 * @version $Id: GnuRegExpFactory.java,v 1.4 2005-04-12 08:47:38 steffen Exp $ */

public class GnuRegExpFactory 
  extends RegExpFactory {

  /**
   * This creates a new instance of <code>GnuRegExpFactory</code>. */
  public GnuRegExpFactory() {
    // nothing to do
  }
  ...
  public RegExp createRegExp(String regExpString) 
    ...
    return new GnuRegExp(regExpString);
  }
}
