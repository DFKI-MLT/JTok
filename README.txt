...
Execute "mvn install" to create target/jtok-core-X.Y.Z.jar that contains the
...
to add your configuration folder in front of jtok-core-X.Y.Z.jar in the 
classpath.
...
in target/jtok-core-X.Y.Z-bin.zip that also contains all 3rd party libraries.
...
src/main/resources
     ...
     the JVM classpath in front of jtok-core-X.Y.Z.jar.
